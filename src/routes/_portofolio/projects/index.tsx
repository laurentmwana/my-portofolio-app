...
import { findPaginatedProjectsPublished } from "#/actions/project.action";
...
export const Route = createFileRoute("/_portofolio/projects/")({
	component: Page,
	...
	loader: async ({ deps }) => {
		...
		return await findPaginatedProjectsPublished({
			data: {
				limit: limit,
				page: page,
				offset,
...
function Page() {
	...
	const { count, items: projects } = Route.useLoaderData();

	return (
		<div className="container">
			<Banner
				breadcrumbs={[{ label: "Accueil", href: "/" }, { label: "Projects" }]}
				title="Mes Projets"
